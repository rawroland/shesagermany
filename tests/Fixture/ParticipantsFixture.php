...
class ParticipantsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'type' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => 'person', 'comment' => '', 'precision' => null],
        ...
        '_indexes' => [
            'participants_people' => ['type' => 'index', 'columns' => ['person_id'], 'length' => []],
            'fk_organizations' => ['type' => 'index', 'columns' => ['organization_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'fk_organizations' => ['type' => 'foreign', 'columns' => ['organization_id'], 'references' => ['organizations', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
