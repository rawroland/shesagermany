...
class ActivitiesTableTest extends TestCase {
  ...
  public function testValidationFailsWithoutTitle() {
    ...
    $event = $this->Activities->newEntity($this->data);
    $errors = $event->errors();
    $this->assertTrue(!empty($errors), 'No errors were triggered without the title field');
    $this->assertFalse($this->Activities->save($event), 'Event was saved without the title field.');
  }
  ...
  public function testValidationFailsWithEmptyTitle() {
    ...
    $this->assertFalse($this->Activities->save($event), 'Event was saved with an empty title value.');
  }
  ...
  public function testValidationFailsWithShortTitle() {
    ...
    $this->assertFalse($this->Activities->save($event), 'Event was saved with a short title field.');
  }
  ...
  public function testValidationFailsWithoutDescription() {
    ...
    $this->assertFalse($this->Activities->save($event), 'Event was saved without the description field.');
  }
  ...
  public function testValidationFailsWithEmptyDescription() {
    ...
    $this->assertFalse($this->Activities->save($event), 'Event was saved with an empty description value.');
  }
  ...
  public function testValidationFailsWithInvalidDescriptionData() {
    ...
    $this->assertFalse($this->Activities->save($event), 'Event was saved with a short description value.');
  }
  ...
  public function testValidationFailsWithoutDate() {
    ...
    $this->assertFalse($this->Activities->save($event), 'Event was saved without the date field.');
  }
  ...
  public function testValidationFailsWithEmptyDate() {
    ...
    $this->assertFalse($this->Activities->save($event), 'Event was saved with an empty date value.');
  }
  ...
  public function testValidationFailsWithInvalidDateTimeData() {
    ...
    $this->assertFalse($this->Activities->save($event), 'Event was saved with an invalid date.');
  }
}
